// /SnapLeadAR/src/tests/services/googleSheets.test.js
...
describe("Google Sheets Integration", () => {
    ...
    describe("Sheet Operations", () => {
        ...
        test("should update existing row when email exists", async () => {
            // Mock para encontrar o email existente
...
// Helper functions utilizadas nos testes
