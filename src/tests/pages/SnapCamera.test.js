// /SnapLeadAR/src/tests/pages/SnapCamera.test.js
...
describe("SnapCamera Component", () => {
    ...
    beforeEach(() => {
        ...
        // Mock da URL com lens_id
        delete window.location;
        window.location = new URL(
            `http://localhost:8016/snapleadar/?snaplead_id=${mockLensId}`,
        );
    });
    ...
    test("validates lens ID from URL", async () => {
        ...
        window.location = new URL(
            "http://localhost:8016/snapleadar/?snaplead_id=invalid-id",
        );
